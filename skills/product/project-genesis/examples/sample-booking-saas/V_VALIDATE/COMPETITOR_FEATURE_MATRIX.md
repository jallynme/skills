# Competitor & Feature Matrix — Sample-Booking (filled example)

> Built by the Competitor Analyst (deep-research + live sites + app-store reviews). Raw evidence;
> decision in `FEATURE_MAP.md`. Copy patterns, never protected IP.

## 1. Competitive set
| # | Competitor | Type | Segment | Pricing (from) | Platforms | Notes |
|---|---|---|---|---|---|---|
| 1 | Calendly | direct | teams + solos | $0 / $10 / $16 seat | Web·iOS·Android | scheduling-first; deposits are a bolt-on |
| 2 | Acuity (Squarespace) | direct | solos/SMB | $16 / $27 / $49 | Web·iOS·Android | powerful but complex; steep setup |
| 3 | Square Appointments | direct | retail/services | $0 + card fees | Web·iOS·Android | POS-first; heavy for a solo |
| 4 | SimplyBook.me | direct | global SMB | $0 / $9.9 / $29.9 | Web·iOS·Android | feature-rich, dated UX |
| 5 | DMs + paper book | substitute | everyone | free | phone | the real competition |
...
|---|---|---|---|
| Calendly | Free/Std/Teams | seats, integrations | 14-day |
...
- Table-stakes we must match: booking link, reminders, calendar sync, client list.
- Differentiators: deposit-to-confirm, mobile push.
- Delighter / wedge: auto-refund-on-attend, beautifully on mobile.
