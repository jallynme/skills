# Competitor & Feature Matrix — <PROJECT_NAME>  (Station V — Feature Discovery)

> Owned by the **Competitor Analyst** (with CPO). Built from **deep-research** + live competitor
> sites/apps (Claude in Chrome) + app-store listings & reviews. This is the raw evidence; the
> decision lives in `FEATURE_MAP.md`.
>
> **Companion files:** `FEATURE_CATALOG.md` (the full feature inventory) · `competitor-<name>.md`
> (one deep profile per rival) · `FEATURE_BENCHMARK.md` (0–5 quality scores → leapfrog spots).
>
> **Copycat rule:** replicate common patterns & table-stakes (conventions); never clone proprietary
> content/brand/trademarks/patents (flag those for Counsel). Win = parity + a wedge + one leapfrog.

## 1. The competitive set
| # | Competitor / substitute | Type (direct / substitute / DIY) | Segment | Pricing (from) | Platforms (Web/iOS/Android) | Notes |
|---|---|---|---|---|---|---|
| 1 | <name> | direct | <ICP> | <$/mo> | Web · iOS · Android | <…> |
| 2 | <name> | substitute (e.g. spreadsheet) | | | | |
...
- **Table-stakes we must have:** <list>
- **Differentiators (pick our wedge):** <list>
- **Delighters / leapfrog (1 big bet):** <…>
- **Features the founder didn't mention but the market expects:** <list — the "you should also build…">
